        ...
        <div class="panel panel-primary">
          ...
          <table id="qingyun_online" class="table table-bordered table-striped" cellspacing="0" width="100%">
            ...
            <tr>
              ...
              <th class="per10">开始时间</th>
            </tr>
            </thead>
            <tbody>

            <tr>
              <c:forEach var="handle" items="${handleHistory}">
                <td>${handle.hname}</td>
                <fmt:formatDate value="${handle.handelTime}" pattern="yyyy.MM.dd HH.mm" />                <td id="handle_time"></td>
              </c:forEach>
      ...
      <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
          ...
          <table id="basic-datatables" class="table table-bordered table-striped" cellspacing="0" width="100%">
            ...
            <tbody>
            <c:forEach var="achieve" items="${cleanHistoryList}">
              <tr>
