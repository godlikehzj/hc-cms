    ...
    <div class="col-lg-12">
      ...
      <div class="panel panel-default toggle">
        ...
        <div class="panel-heading">
          <h3 class="panel-title">创建垃圾屋</h3>
        </div>
        <div class="panel-body">
          <form class="form-horizontal group-border hover-stripped" action="${ctx}/house/add.do" method="get" role="form">
            <div class="form-group">
              <label class="col-lg-2 col-md-2 col-sm-12 control-label">名称</label>
              <div class="col-lg-10 col-md-10">
                <input type="text" class="form-control" name="hname" placeholder="" autofocus="autofocus">
              </div>
            </div>
            <div class="form-group">
              <label class="col-lg-2 col-md-2 col-sm-12 control-label">描述</label>
              <div class="col-lg-10 col-md-10">
                <input type="text" class="form-control" name="description" placeholder="" autofocus="autofocus">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-lg-10 col-md-10">
                <input id="addr" type="text" class="form-control" name="addr" placeholder="" autofocus="autofocus">
            ...
            <div class="form-group">
              <div class="col-lg-2 col-md-2 col-sm-12 control-label ">
                <button id="create_house" type="submit" class="btn btn-success">提交</button>
